...
{     
	...
	while (wserv_testStatus.dwCurrentState!=SERVICE_STOPPED)
	{
		if (wserv_testStatus.dwCurrentState!=SERVICE_PAUSED)
		{
			...
			fp = fopen(/*"c:\\Test\\serv_log.txt", "a"*/"C:\\Users\\dimka\\Desktop\\sem5\\OS\\Lab15\\service1.exe", "a");
...
void main(int argc, char *argv[])
{
	...
	if (!(svc = CreateService(scm,"wserv_test","wserv_test", SERVICE_ALL_ACCESS, SERVICE_WIN32_OWN_PROCESS, SERVICE_DEMAND_START, SERVICE_ERROR_NORMAL, pname, NULL,NULL,NULL,NULL,NULL)))
	{
